...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/service-one.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 12:42:40 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <div class="header-top-left">
                                   <ul class="contact-info list-style">
                                       ...
                                       <li><i class="flaticon-email-1"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#d9b1bcb5b5b699abb8a1b8f7bab6b4"><span class="__cf_email__" data-cfemail="85ede0e9e9eac5f7e4fde4abe6eae8">[email&#160;protected]</span></a></li>
                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse main-menu-wrap" id="navbarSupportedContent">
                                ...
                                <ul class="navbar-nav ms-auto">
                                   ...
                                   <li class="nav-item ">
                                         <a href="service-one.php" class="nav-link active">Service </a>
                ...
                <section class="service-wrap ptb-100">
                    <div class="container">
                                ...
                                <div class="service-card style4">
                                    <div class="service-info">
                                        <div class="service-title">
                                            ...
                                            <h3><a href="service-details.php">Fraud Detection</a></h3>
                                        </div>
                                        ...
                                        <a href="service-details.php" class="link style1">Learn More <i class="flaticon-right-arrow-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="service-card style4">
                                    <div class="service-info">
                                        <div class="service-title">
                                            ...
                                            <h3><a href="service-details.php">Account Updater</a></h3>
                                        </div>
                                        <p>Lorem ipsum dolor sit amet dolor alut const slice elit aliquid dolor ametin perfer endis velit sed fuga volup tation sit praising pain.</p>
                                        <a href="service-details.php" class="link style1">Learn More <i class="flaticon-right-arrow-1"></i></a>
                                    </div>
                                ...
                                <div class="service-card style4">
                                    <div class="service-info">
                                        <div class="service-title">
                                            ...
                                            <h3><a href="service-details.php">Payment Invoice</a></h3>
                                        </div>
                                        <p>Lorem ipsum dolor sit amet dolor alut const slice elit aliquid dolor ametin perfer endis velit sed fuga volup tation sit praising pain.</p>
                                        <a href="service-details.php" class="link style1">Learn More <i class="flaticon-right-arrow-1"></i></a>
                                    </div>
                                ...
                                <div class="service-card style4">
                                    <div class="service-info">
                                        <div class="service-title">
                                            ...
                                            <h3><a href="service-details.php">Secure Payment</a></h3>
                                        </div>
                                        <p>Lorem ipsum dolor sit amet dolor alut const slice elit aliquid dolor ametin perfer endis velit sed fuga volup tation sit praising pain.</p>
                                        <a href="service-details.php" class="link style1">Learn More <i class="flaticon-right-arrow-1"></i></a>
                                    </div>
                                ...
                                <div class="service-card style4">
                                    <div class="service-info">
                                        <div class="service-title">
                                            ...
                                            <h3><a href="service-details.php">Home Loan</a></h3>
                                        </div>
                                        <p>Lorem ipsum dolor sit amet dolor alut const slice elit aliquid dolor ametin perfer endis velit sed fuga volup tation sit praising pain.</p>
                                        <a href="service-details.php" class="link style1">Learn More <i class="flaticon-right-arrow-1"></i></a>
                                    </div>
                        ...
                        <ul class="page-nav list-style mt-20">
                            <li><a href="service-two.php"><i class="flaticon-back"></i></a></li>
                            <li><a class="active" href="service-two.php">1</a></li>
                            <li><a href="service-two.php">2</a></li>
                            <li><a href="service-two.php">3</a></li>
                            <li><a href="service-two.php"><i class="flaticon-next-1"></i></a></li>
                        </ul>
                    </div>
                </section>
                <!-- Service Section End -->
...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/service-one.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 12:42:41 GMT -->
</html>