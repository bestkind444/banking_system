...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 12:42:39 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-12 order-lg-1 order-2">
                                <div class="shopping-content">
                                    ...
                                    <a href="register.php" class="btn style1">Signup Today</a>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-md-4 text-md-end sm-center">
                                <div class="app-btn">
                                    <a href="https://play.google.com/store/apps" target="_blank"><img src="assets/img/play-store.png" alt="Image"></a>
