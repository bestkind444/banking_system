...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/blog-details-left-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 12:43:08 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <div class="header-top-left">
                                   <ul class="contact-info list-style">
                                       ...
                                       <li><i class="flaticon-email-1"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#ff979a939390bf8d9e879ed19c9092"><span class="__cf_email__" data-cfemail="ddb5b8b1b1b29dafbca5bcf3beb2b0">[email&#160;protected]</span></a></li>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="blog-details-left-sidebar.php" class="nav-link active">Blog Details Left Sidebar</a>
                                                    </li>
                                                    <li class="nav-item">
                            ...
                            <div class="col-lg-7 col-md-8 col-sm-8">
                                <div class="breadcrumb-title">
                                    ...
                                    <ul class="breadcrumb-menu list-style">
                                        ...
                                        <li><a href="blog-left-sidebar.php">Blog </a></li>
                            ...
                            <div class="col-xl-4 col-lg-12 order-xl-1 order-lg-2 order-md-2 order-2">
                                <div class="sidebar">
                                    ...
                                    <div class="sidebar-widget popular-post">
                                        ...
                                        <div class="popular-post-widget">
                                            <div class="pp-post-item">
                                                <a href="blog-details-right-sidebar.php" class="pp-post-img">
                                                    <img src="assets/img/blog/post-thumb-1.jpg" alt="Image">
                                                </a>
                                                <div class="pp-post-info">
                                                    <span><i class="flaticon-calendar"></i>01 Nov, 2024</span>
                                                    <h6>
                                                        <a href="blog-details-no-sidebar.php">
                                                            Bank Is The Best Way To Save In The Future
                                                        </a>
                                                    </h6>
                                                </div>
                                            </div>
                                            <div class="pp-post-item">
                                                ...
                                                <div class="pp-post-info">
                                                    <span><i class="flaticon-calendar"></i>25 Sep, 2024</span>
                                                    <h6>
                                                        <a href="blog-details-no-sidebar.php">
                                            ...
                                            <div class="pp-post-item">
                                                ...
                                                <div class="pp-post-info">
                                                    <span><i class="flaticon-calendar"></i>12 Sep, 2024</span>
                                                    <h6>
                                                        <a href="blog-details-no-sidebar.php">
                                    ...
                                    <div class="sidebar-widget tags">
                                        ...
                                        <div class="tag-list">
                                            <ul class="list-style">
                                                <li><a href="posts-by-tag.php">Business</a></li>
                                                <li><a href="posts-by-tag.php">Costs</a></li>
                                                <li><a href="posts-by-tag.php">Interest</a></li>
                                                <li><a href="posts-by-tag.php">Loan</a></li>
                                                <li><a href="posts-by-tag.php">Payment</a></li>
                                                <li><a href="posts-by-tag.php">Cards</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-8 col-lg-12 order-xl-2 order-lg-1 order-md-1 order-1">
                                <article>
                                    ...
                                    <ul class="post-metainfo  list-style">
                                        <li><i class="flaticon-user"></i><a href="posts-by-author.php">Admin</a></li>
                                        <li><i class="flaticon-calendar"></i><a href="posts-by-date.php">01 Nov, 2024</a></li>
                                    ...
                                    <div class="post-para">
                                        ...
                                        <p>No sea takimata sanctus est Lorem <a href="index-2.php">Ipsum</a> dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et.</p>
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur <strong>adipisicing</strong> elit, sed do eiusmod tempor quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in <a href="index-2.php">sed</a> uia non numquam eius modi tempora incidunt ut labore dolor.</p>
                                    </div>
                                </article>
                                        ...
                                        <div class="col-md-7 col-12">
                                            <div class="post-tag">
                                                ...
                                                <ul class="tag-list list-style">
                                                    <li><a href="posts-by-tag.php">Loan</a>,</li>
                                                    <li><a href="posts-by-tag.php">Banking</a>,</li>
                                                    <li><a href="posts-by-tag.php">Card</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row align-items-start">
                                                        <div class="col-md-9 col-sm-12 col-12 order-md-1 order-sm-1 order-1">
                                                            <div class="comment-author-name">
                                                                <h5>Olivic Dsuza <span class="comment-date">Oct 22, 2024</span></h5>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="comment-author-wrap">
                                                <div class="comment-author-info">
                                                    <div class="row align-items-start">
                                                        <div class="col-md-9 col-sm-12 col-12 order-md-1 order-sm-1 order-1">
                                                            <div class="comment-author-name">
                                                                <h5>Everly Leah <span class="comment-date">Oct 30, 2024</span></h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-sm-12 col-12 text-md-end order-md-2 order-sm-3 order-3">
                                                            <a href="#cmt-form" class="reply-btn">Reply</a>
                                            ...
                                            <div class="comment-author-wrap">
                                                <div class="comment-author-info">
                                                    <div class="row align-items-start">
                                                        <div class="col-md-9 col-sm-12 col-12 order-md-1 order-sm-1 order-1">
                                                            <div class="comment-author-name">
                                                                <h5>Ella Jackson <span class="comment-date">Sep 15, 2024</span></h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-sm-12 col-12 text-md-end order-md-2 order-sm-3 order-3">
                                                            <a href="#cmt-form" class="reply-btn">Reply</a>
