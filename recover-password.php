...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/recover-password.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 12:42:58 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <div class="header-top-left">
                                   <ul class="contact-info list-style">
                                       ...
                                       <li><i class="flaticon-email-1"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#f199949d9d9eb183908990df929e9c"><span class="__cf_email__" data-cfemail="472f222b2b280735263f266924282a">[email&#160;protected]</span></a></li>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="recover-password.php" class="nav-link active">Recover Password</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
