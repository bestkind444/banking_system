...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/service-two.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 12:42:41 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <div class="header-top-left">
                                   <ul class="contact-info list-style">
                                       ...
                                       <li><i class="flaticon-email-1"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#82eae7eeeeedc2f0e3fae3ace1edef"><span class="__cf_email__" data-cfemail="bed6dbd2d2d1feccdfc6df90ddd1d3">[email&#160;protected]</span></a></li>
                                ...
                                <ul class="navbar-nav ms-auto">
                                   ...
                                   <li class="nav-item has-dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="service-two.php" class="nav-link active">Service Two</a>
                                            </li>
                                             <li class="nav-item">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="service-card style1">
                                    ...
                                    <h3><a href="service-details.php">Secured Transaction</a></h3>
                                    <p>Lorem ipsum dolor sit ametus situlo consec tetur adicingus elittque coris sapite illo sit.</p>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="service-card style1">
                                    ...
                                    <h3><a href="service-details.php">Verified Account</a></h3>
                                    <p>Lorem ipsum dolor sit ametus situlo consec tetur adicingus elittque coris sapite illo sit.</p>
                                </div>
                            </div>
                        </div>
                        <ul class="page-nav list-style mt-20">
                            <li><a href="service-one.php"><i class="flaticon-back"></i></a></li>
                            <li><a class="active" href="service-one.php">1</a></li>
                            <li><a href="service-one.php">2</a></li>
                            <li><a href="service-one.php">3</a></li>
                            <li><a href="service-one.php"><i class="flaticon-next-1"></i></a></li>
                        </ul>
                    </div>
                </section>
                <!-- Service Section End -->
...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/service-two.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 12:42:43 GMT -->
</html>