                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="project-card">
                                    ...
                                    <div class="project-info">
                                        ...
                                        <h3><a href="project-details.php">Financial Loan</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="project-card">
                                    ...
                                    <div class="project-info">
                                        ...
                                        <h3><a href="project-details.php">Mobile Banking</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="project-card">
                                    ...
                                    <div class="project-info">
                                        ...
                                        <h3><a href="project-details.php">Online payment</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="project-card">
                                    ...
                                    <div class="project-info">
                                        ...
                                        <h3><a href="project-details.php">Tax Processing</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="project-card">
                                    ...
                                    <div class="project-info">
                                        ...
                                        <h3><a href="project-details.php">Home Loan</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="project-card">
                                    ...
                                    <div class="project-info">
                                        ...
                                        <h3><a href="project-details.php">Budget Planning</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <ul class="page-nav list-style mt-20">
                            <li><a href="project.php"><i class="flaticon-back"></i></a></li>
                            <li><a class="active" href="project.php">1</a></li>
                            <li><a href="project.php">2</a></li>
                            <li><a href="project.php">3</a></li>
                            <li><a href="project.php"><i class="flaticon-next-1"></i></a></li>
                        </ul>
                    </div>
                </section>
                <!-- Project section end -->
