...
<!-- Mirrored from templates.hibootstrap.com/raxa/default/open-account.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Oct 2025 12:42:56 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <div class="header-top-left">
                                   <ul class="contact-info list-style">
                                       ...
                                       <li><i class="flaticon-email-1"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#7119141d1d1e31031009105f121e1c"><span class="__cf_email__" data-cfemail="59313c353536192b382138773a3634">[email&#160;protected]</span></a></li>
                                ...
                                <ul class="navbar-nav ms-auto">
                                   ...
                                   <li class="nav-item has-dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="open-account.php" class="nav-link active">Open Account</a>
                                            </li>
                                            <li class="nav-item">
